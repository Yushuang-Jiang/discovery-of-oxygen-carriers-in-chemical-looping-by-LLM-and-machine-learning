...
log_file = Path("training_log-test.txt")
...
class TransformerModel(nn.Module):
    def __init__(self, num_features, d_model, num_heads, num_layers, transformer_dropout, fc_dropout, fc1_size, dim_feedforward, seq_length=30):
        ...
        self.transformer = nn.TransformerEncoder(
            nn.TransformerEncoderLayer(d_model=d_model, nhead=num_heads, dropout=transformer_dropout, dim_feedforward=dim_feedforward, batch_first=True),
...
# Excel file path in the parent directory
file_path = Path("..") / "XRD-capacity.xlsx"
...
for train_size in train_sizes:
    for random_state in random_states:
        ...
        def optimize_model(learning_rate, dim_feedforward_factor, fc1_size, transformer_dropout, fc_dropout, num_heads_idx):
            ...
            if r2_test > 0.88:
                model_name = f"Transformer-{train_size}_{random_state}_trainMSE_{mse_train:.4f}_trainR2_{r2_train:.4f}_testMSE_{mse_test:.4f}_testR2_{r2_test:.4f}.pt"
